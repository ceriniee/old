...
# graph features
data['n_drug'] = data['d_feat'].shape[0] #drug 수
data['n_prot'] = data['p_feat'].shape[0] #prot 수
...
data['dp_edge_index'] = data['dp_edge_index'].to(torch.long)
print(data['dp_edge_index'].dtype)
